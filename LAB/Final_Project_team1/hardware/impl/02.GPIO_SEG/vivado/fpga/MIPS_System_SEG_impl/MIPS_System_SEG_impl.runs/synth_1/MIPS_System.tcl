...
read_mem C:/2024_CA_LAB/LAB/Final_Project_team1/software/02.seg/code.hex
...
set_property used_in_implementation false [get_files C:/2024_CA_LAB/LAB/Final_Project_team1/hardware/impl/02.GPIO_SEG/vivado/xdc/FPGA_Starter_Kit_III.xdc]

set_param ips.enableIPCacheLiteLoad 1
close [open __synthesis_is_running__ w]

synth_design -top MIPS_System -part xc7a75tfgg484-2L


# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef MIPS_System.dcp
create_report "synth_1_synth_report_utilization_0" "report_utilization -file MIPS_System_utilization_synth.rpt -pb MIPS_System_utilization_synth.pb"
